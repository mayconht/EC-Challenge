...
public class ChallengeCodeEcoreApplication  implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Role role1 = new Role("6ec4c0f7-ab65-49ed-9e78-90752b5d2df8", "Dev", "Developer Role");
		Role role2 = new Role("0bacfe69-9de5-415d-9293-a7c49fa5d861", "PO", "Product Owner Role");
		Role role3 = new Role("218b6b45-a792-49e6-a844-1a2b34eb7827", "Tester", "Tester Role");
